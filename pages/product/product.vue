	...
	<view class="container">
		<view class="swiper-box">
			<swiper indicator-dots circular=true duration="400">
				<swiper-item class="swiper-item" v-for="(item, index) in productImages" :key="index">
		...
		<view class="share-section" @click="share">
			...
			<text class="iconfont icon-bangzhu1"></text>
		...
		<view class="atv-list">
			<view class="atv-row" @click="toggleSpec">
		...
		<view class="page-bottom">
			<navigator url="/pages/index/index" open-type="switchTab" class="p-b-btn">
				<text class="iconfont icon-xiatubiao--copy"></text>
				<text>首页</text>
			</navigator>
